...
define('_BLOCKPROBLEM','<div class="text-center">Il y a un probleme avec ce bloc.</div>');
define('_BLOCKPROBLEM2','<div class="text-center">Il n\'y a rien dans ce block.</div>');
...
define('_JSWARN','Ce site fonctionne mieux avec <a href="http://www.activatejavascript.org">JavaScript activ&eacute;</a>.');
define('_JULY','July');
define('_JUNE','June');
...
define('_MODULESADMINS','Nous sommes désolé mais cette section de notre site est réservée aux <span class="italic">administrateurs seulement</span><br /><br />');
define('_MODULESSUBSCRIBER','We are Sorry but this section of our site is for <span class="italic">Subscribed Users Only.</span>');
define('_MODULEUSERS','Nous sommes désolé mais cette section de notre site est pour les <span class="italic">utilisateurs enregistrés seulement</span><br /><br />Vous pouvez vous enregistrer gratuitement en cliquant <a href="modules.php?name=Your_Account&amp;op=new_user">ici</a>, puis vous pouvez<br />accéder à cette section sans réstriction. Merci.<br /><br />');
