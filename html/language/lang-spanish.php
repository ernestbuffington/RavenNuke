...
if (!defined('_BCHGTHEME')) define('_BCHGTHEME','Cambiar Tema');
define('_BIGSTORY','La historia m&aacute;s le&iacute;da del dia es:');
define('_BLATEST','&Uacute;ltimo(s)');
define('_BLOCKPROBLEM','<div class="text-center">Actualmente hay un problema con este bloque.</div>');
define('_BLOCKPROBLEM2','<div class="text-center">Actualmete no hay contenido para este bloque.</div>');
...
if (!defined('_BPREFS')) define('_BPREFS','Preferencias');
...
define('_JSWARN','Este sitio funciona mejor con <a href="http://www.activatejavascript.org">JavaScript activado</a>.');
define('_JULY','Julio');
define('_JUNE','Junio');
...
define('_MODULESADMINS', 'Lo sentimos pero esta secci&oacute;n del sitio es para <span class="italic">Administradores Solamente.</span><br /><br />');
define('_MODULESSUBSCRIBER','Lo sentimos pero esta secci&oacute;n del sitio es para <span class="italic">Usuarios Suscritos Solamente.</span>');
define('_MODULEUSERS', 'Lo sentimos pero esta secci&oacute;n del sitio es para <span class="italic">Usuarios Registrados Solamente.</span><br /><br />Puedes registrarte gratuitamente <a href="modules.php?name=Your_Account&amp;op=new_user">AQU&Iacute;</a>, despu&eacute;s vas a poder<br />accesar a esta secci&oacute;n sin restricciones. Gracias.<br /><br />');
