...
define('_AREYOUSURE','(Se hai incluso qualche URL, assicurati di averlo convalidato e testato per eventuali errori di battitura.)');
...
if (!defined('_BCHGTHEME')) define('_BCHGTHEME','Cambia tema');
define('_BIGSTORY','L\'articolo pi&#249; letto di oggi &#232;:');
define('_BLATEST','Ultimo');
define('_BLOCKPROBLEM','<div class="text-center">C\'&#232; un problema con questo blocco.</div>');
define('_BLOCKPROBLEM2','<div class="text-center">Al momento non c\'&#232; nessun contenuto per questo blocco.</div>');
define('_BMEM','Iscritti');
define('_BMEMP','Iscrizione');
define('_BON','Online ora');
define('_BOVER','Complessivi');
define('_BPM','Messaggi privati');
if (!defined('_BPREFS')) define('_BPREFS','Preferenze');
define('_BREAD','Letti');
...
define('_JOURNAL','Diario Online');
define('_JSWARN','Questo sito funziona meglio con <a href="http://www.activatejavascript.org">abilitare Javascript</a>.');
define('_JULY','Luglio');
define('_JUNE','Giugno');
...
define('_MODULESADMINS', 'Siamo spiacenti ma questa sezione del nostro sito &#232; <span class="italic">solamente per amministratori.</span><br /><br />');
define('_MODULESSUBSCRIBER','Siamo spiacenti ma questa sezione del nostro sito &#232; <span class="italic">solamente per utenti iscritti.</span>');
define('_MODULEUSERS', 'Siamo spiacenti ma questa sezione del nostro sito &#232; <span class="italic">solamente per utenti registrati.</span><br /><br />Puoi registrarti gratuitamente seguendo questo link <a href="modules.php?name=Your_Account&amp;op=new_user">qui</a>, poi puoi <br />accedere a questa sezione senza restrizioni. Grazie.<br /><br />');
...
define('_READMYJOURNAL','Leggi il mio Diario Online');
...
define('_YES','Si');
define('_YOUARE','Sei');
define('_YOUAREANON','<span color=\"red\">Non ci conosciamo ancora? Registrati gratuitamente <a href="modules.php?name=Your_Account&amp;op=new_user">Qui</a></span>');
...
define('_RWS_WIW_TITLE','Chi &egrave; dove');
