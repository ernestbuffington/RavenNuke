...
define('_JSWARN','This site works best with <a href="http://www.activatejavascript.org">JavaScript enabled</a>.');
define('_JULY','July');
define('_JUNE','June');
...
define('_MODULESADMINS', 'We are Sorry but this section of our site is for <span class="italic">Administrators Only.</span><br /><br />');
define('_MODULESSUBSCRIBER','We are Sorry but this section of our site is for <span class="italic">Subscribed Users Only.</span>');
define('_MODULEUSERS', 'We are Sorry, but this section of our site is for <span class="italic">Registered Users Only.</span><br /><br />You can register for free by clicking <a href="modules.php?name=Your_Account&amp;op=new_user">here</a>, then you can<br />access this section without restrictions. Thanks.<br /><br />');
