...
$pagetitle = _AB_NUKESENTINEL.": "._AB_CONFIGURATION.": "._AB_CLIKEBLOCKER;
include("header.php");
OpenTable();
OpenMenu(_AB_CLIKEBLOCKER);
mastermenu();
CarryMenu();
configmenu();
CloseMenu();
...
echo '<input type="hidden" name="xblocker_row[block_name]" value="clike" />'."\n";
...
echo '<tr><td align="center" bgcolor="'.$bgcolor2.'" colspan="2"><strong>'._AB_CLIKEBLOCKER.'</strong></td></tr>'."\n";
