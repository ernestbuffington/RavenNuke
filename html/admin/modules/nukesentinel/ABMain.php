...
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_078).' '._AB_SHOWRIGHT.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_114).' '._AB_TESTSWITCH.':</td>'."\n";
$seltest1 = $seltest2 = "";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_048).' '._AB_DISABLESWITCH.':</td>'."\n";
$seldable1 = $seldable2 = "";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_003).' '._AB_SITESWITCH.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_004).' '._AB_TEMPLATE.':</td>'."\n";
...
for($i=0; $i < sizeof($templatelist); $i++) {
	if($templatelist[$i] != '') {
		$bl = str_ireplace('admin_', '', $templatelist[$i]);
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_068).' '._AB_HELPSWITCH.':</td>'."\n";
$selhelp1 = $selhelp2 = "";
...
echo '</select></td></tr>'."\n";
$seldns1 = $seldns2 = "";
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_086).' '._AB_IPLOOKUPSITE.':</td>'."\n";
...
echo '<option value="http://www.DNSstuff.com/tools/whois/?ip="'.$seldns2.'>DNS Stuff</option>'."\n";
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_047).' '._AB_FORCENUKEURL.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_118).' '._AB_PAGEDELAY.':</td>'."\n";
...
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_072).' '._AB_FLOODDELAY.':</td>'."\n";
...
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_001).' '._AB_DISPLAYLINK.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_002).' '._AB_DISPLAYREASON.':</td>'."\n";
...
echo '<option value="3"'.$sel4.'>'._AB_VISITORS.'</option>'."\n";
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_044).' '._AB_PROXYBLOCKER.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_045).' '._AB_TEMPLATE.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_042).' '._AB_SELFEXPIRE.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_056).' '._AB_SANTYPROTECTION.':</td>'."\n";
$selsanty1 = $selsanty2 = "";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_046).' '._AB_PREVENTDOS.':</td>'."\n";
$seldos1 = $seldos2 = "";
...
echo '<tr><td bgcolor="'.$bgcolor2.'" valign="top">'.help_img(_AB_HELP_007).' '._AB_ADMINAUTH.':</td>'."\n";
...
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_050).' '._AB_IPTRACKER.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_051).' '._AB_MAXIMUMDAYS.':</td>'."\n";
...
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_008).' '._AB_IPSPERPAGE.':</td>'."\n";
echo '<td><input type="text" name="xblock_perpage" size="5" value="'.$ip_sets['block_perpage'].'" /></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_009).' '._AB_SORTCOLUMN.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_010).' '._AB_SORTDIRECTION.':</td>'."\n";
...
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_053).' '._AB_IPSPERPAGE.':</td>'."\n";
echo '<td><input type="text" name="xtrack_perpage" size="5" value="'.$ip_sets['track_perpage'].'" /></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_054).' '._AB_SORTCOLUMN.':</td>'."\n";
...
echo '</select></td></tr>'."\n";
echo '<tr><td bgcolor="'.$bgcolor2.'">'.help_img(_AB_HELP_055).' '._AB_SORTDIRECTION.':</td>'."\n";
