...
echo '<tr><td align="center" colspan="2"><span class="italic">'._AB_SEARCHNOTE.'</span></td></tr>'."\n";
...
if($torun > 0) {
  ...
  if($totalselected > 0) {
    echo '<br />'."\n";
    OpenTable();
    echo '<div class="text-center title"><strong>'._AB_SEARCHTRACKEDIPS.'</strong></div><br />'."\n";
  ...
  if($totalselected > 0) {
    echo '<br />'."\n";
    OpenTable();
    echo '<div class="text-center title"><strong>'._AB_USERSDB.'</strong></div><br />'."\n";
