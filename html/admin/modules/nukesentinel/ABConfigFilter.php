...
$pagetitle = _AB_NUKESENTINEL.": "._AB_CONFIGURATION.": "._AB_FILTERBLOCKER;
include("header.php");
OpenTable();
OpenMenu(_AB_FILTERBLOCKER);
mastermenu();
CarryMenu();
configmenu();
CloseMenu();
...
echo '<input type="hidden" name="xblocker_row[block_name]" value="filter" />'."\n";
echo '<input type="hidden" name="xop" value="'.$op.'" />'."\n";
echo '<input type="hidden" name="op" value="ABConfigSave" />'."\n";
echo '<table summary="" align="center" border="0" cellpadding="2" cellspacing="2">'."\n";
$blocker_row = abget_blocker("filter");
$blocker_row['duration'] = $blocker_row['duration'] / 86400;
echo '<tr><td align="center" bgcolor="'.$bgcolor2.'" colspan="2"><strong>'._AB_FILTERBLOCKER.'</strong></td></tr>'."\n";
