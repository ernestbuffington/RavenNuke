...
echo '<tr bgcolor="#ffffff"><td><strong>'._AB_EXPIRES.':</strong></td><td>'.$getIPs['expires'].'</td></tr>'."\n";
echo '<tr bgcolor="#ffffff"><td valign="top"><strong>'._AB_NOTES.':</strong></td><td>'.$getIPs['notes'].'</td></tr>'."\n";
echo '<tr bgcolor="#ffffff"><td><strong>'._AB_REASON.':</strong></td><td>'.$blockerrow['reason'].'</td></tr>'."\n";
