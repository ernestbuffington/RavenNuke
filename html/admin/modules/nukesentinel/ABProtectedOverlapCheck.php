...
if(!isset($min)) {
  ...
  $pages = ceil($pagesint);
  $pagetitle = _AB_NUKESENTINEL.": "._AB_PROTECTEDOVERLAPCHECK;
  include("header.php");
  OpenTable();
  OpenMenu(_AB_PROTECTEDOVERLAPCHECK);
  mastermenu();
  CarryMenu();
  protectedmenu();
  CloseMenu();
  ...
  echo '<br />'."\n";
  OpenTable();
  echo _AB_PROTECTEDOVERLAPCHECK01.'<br />'."\n";
  echo _AB_PROTECTEDOVERLAPCHECK02.'<br />'."\n";
  echo _AB_INSECTIONS.'<br />'."\n";
  echo _AB_YOUHAVE.$pages._AB_SECTIONSTOGO.'<br />'."\n";
  echo '<br />'."\n";
  echo '<form method="post" action="'.$admin_file.'.php?op=ABProtectedOverlapCheck">'."\n";
  ...
  OpenTable();
  $testmessage = "";
  $result = $db->sql_query("SELECT `ip_lo`, `ip_hi` FROM `".$prefix."_nsnst_protected_ranges` ORDER BY ip_lo LIMIT $min, $perpage");
  while(list($xip_lo, $xip_hi) = $db->sql_fetchrow($result)) {
    $test1 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_protected_ranges WHERE (ip_lo<='$xip_lo' AND ip_hi>='$xip_lo') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
    $test2 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_protected_ranges WHERE (ip_lo<='$xip_hi' AND ip_hi>='$xip_hi') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
    $test3 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_protected_ranges WHERE (ip_lo>='$xip_lo' AND ip_hi<='$xip_hi') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
    $test4 = $db->sql_query("SELECT * FROM ".$prefix."_nsnst_protected_ranges WHERE (ip_lo<='$xip_lo' AND ip_hi>='$xip_hi') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
    ...
    if($testnum1 > 0) {
      ...
      while($testrow1 = $db->sql_fetchrow($test1)) {
        ...
        $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABProtectedEdit&amp;ip_lo='.$testrow1['ip_lo'].'&amp;ip_hi='.$testrow1['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
        $testmessage .= '<a href="'.$admin_file.'.php?op=ABProtectedDelete&amp;ip_lo='.$testrow1['ip_lo'].'&amp;ip_hi='.$testrow1['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
        $testmessage .= '</tr>'."\n";
      }
      $testmessage .= '</table>'."\n";
      $testmessage .= '<br />'."\n";
    ...
    if($testnum2 > 0) {
      ...
      while($testrow2 = $db->sql_fetchrow($test2)) {
        ...
        $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABProtectedEdit&amp;ip_lo='.$testrow2['ip_lo'].'&amp;ip_hi='.$testrow2['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
        $testmessage .= '<a href="'.$admin_file.'.php?op=ABProtectedDelete&amp;ip_lo='.$testrow2['ip_lo'].'&amp;ip_hi='.$testrow2['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
        $testmessage .= '</tr>'."\n";
      }
      $testmessage .= '</table>'."\n";
      $testmessage .= '<br />'."\n";
    ...
    if($testnum3 > 0) {
      ...
      while($testrow3 = $db->sql_fetchrow($test3)) {
        ...
        $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABProtectedEdit&amp;ip_lo='.$testrow3['ip_lo'].'&amp;ip_hi='.$testrow3['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
        $testmessage .= '<a href="'.$admin_file.'.php?op=ABProtectedDelete&amp;ip_lo='.$testrow3['ip_lo'].'&amp;ip_hi='.$testrow3['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
        $testmessage .= '</tr>'."\n";
      }
      $testmessage .= '</table>'."\n";
      $testmessage .= '<br />'."\n";
    ...
    if($testnum4 > 0) {
      ...
      while($testrow4 = $db->sql_fetchrow($test4)) {
        ...
        $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABProtectedEdit&amp;ip_lo='.$testrow4['ip_lo'].'&amp;ip_hi='.$testrow4['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
        $testmessage .= '<a href="'.$admin_file.'.php?op=ABProtectedDelete&amp;ip_lo='.$testrow4['ip_lo'].'&amp;ip_hi='.$testrow4['ip_hi'].'&amp;xop=ABMain" target="_blank"><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
        $testmessage .= '</tr>'."\n";
      }
      $testmessage .= '</table>'."\n";
      $testmessage .= '<br />'."\n";
  ...
  if($testmessage != "") {
    ...
    echo '<tr>'."\n";
    echo '<form action="'.$admin_file.'.php?op=ABProtectedOverlapCheck" method="post">'."\n";
    echo '<td>'."\n";
    echo '<input type="hidden" name="min" value="'.$min.'" />'."\n";
    ...
    echo '{'."\n";
    echo ' location.href = \''.$admin_file.'.php?op=ABProtectedOverlapCheck&min='.$max.csrf_rn_token().'\';'."\n";
    echo '}'."\n";
    echo '// --></script>'."\n";
  ...
  echo '<br />'."\n";
  OpenTable();
  echo '<div class="text-center"><strong>'._AB_PROTECTEDOVERLAPCHECK.' '._AB_COMPLETED.'</strong></div>'."\n";
  CloseTable();
  include("footer.php");
}
