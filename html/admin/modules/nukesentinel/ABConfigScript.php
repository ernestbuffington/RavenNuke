...
$pagetitle = _AB_NUKESENTINEL.": "._AB_CONFIGURATION.": "._AB_SCRIPTBLOCKER;
include("header.php");
OpenTable();
OpenMenu(_AB_SCRIPTBLOCKER);
mastermenu();
CarryMenu();
configmenu();
CloseMenu();
...
echo '<input type="hidden" name="xblocker_row[block_name]" value="script" />'."\n";
...
echo '<tr><td align="center" bgcolor="'.$bgcolor2.'" colspan="2"><strong>'._AB_SCRIPTBLOCKER.'</strong></td></tr>'."\n";
