...
$pagetitle = _AB_NUKESENTINEL.": "._AB_CONFIGURATION.": "._AB_HARVESTBLOCKER;
include("header.php");
OpenTable();
OpenMenu(_AB_HARVESTBLOCKER);
mastermenu();
CarryMenu();
configmenu();
CloseMenu();
...
echo '<br />'."\n";
OpenTable();
$blocker_row = abget_blocker("harvester");
$blocker_row['duration'] = $blocker_row['duration'] / 86400;
echo '<form action="'.$admin_file.'.php" method="post">'."\n";
echo '<input type="hidden" name="xblocker_row[block_name]" value="harvester" />'."\n";
...
echo '<tr><td align="center" bgcolor="'.$bgcolor2.'" colspan="2"><strong>'._AB_HARVESTBLOCKER.'</strong></td></tr>'."\n";
