...
if (!isset($column) or ($column != "ip_lo" and $column != "c2c" and $column != "date")) { $column = "ip_lo"; }
if (!isset($direction) or ($direction != "asc" and $direction != "desc")) { $direction = "asc"; }
$selcolumn1 = $selcolumn2 = $selcolumn3 = $selcolumn4 = $seldirection1 = $seldirection2 = '';
$totalselected = $db->sql_numrows($db->sql_query("SELECT * FROM `".$prefix."_nsnst_ip2country`"));
if ($totalselected > 0) {
  // Page Sorting
