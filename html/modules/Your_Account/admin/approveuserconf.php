...
if (($radminsuper==1) OR ($radminuser==1)) {
    ...
    if ($ya_config['servermail'] == 1) {
	 ...
	 $db->sql_query("UPDATE ".$user_prefix."_users_temp SET time='$time', admin_approve = 1 WHERE user_id='$apr_uid'");
...
//    if (isset($xop)) { echo "<input type='hidden' name='op' value='$xop' />\n"; }
    ...
    echo '<tr><td align="center"><span class="thick">'._YA_APPROVED.' '.$username.' ('.$email.')</span></td></tr>';
    echo '<tr><td align="center"><span class="thick">'._YA_SENDMAIL.'</span></td></tr>';
