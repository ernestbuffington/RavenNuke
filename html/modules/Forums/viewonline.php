...
while ( $row = $db->sql_fetchrow($result) )
{
        ...
        if ( $row['session_logged_in'] )
        {
                ...
                if ( $user_id != $prev_user )
                {
                        ...
                        {
                                $username = '<span class="thick" style="color:#' . $theme['fontcolor3'] . '">' . $username . '</span>';
                        }
                        else if ( $row['user_level'] == MOD )
                        {
                                $username = '<span class="thick" style="color:#' . $theme['fontcolor2'] . '">' . $username . '</span>';
                        }
                        ...
                        if ( !$row['user_allow_viewonline'] )
                        {
                                ...
                                $username = '<span class="italic">' . $username . '</span>';
                        }
                        else
                        {
                                $view_online = true;
