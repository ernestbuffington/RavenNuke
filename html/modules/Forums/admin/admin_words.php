...
if( $mode != "" )
{
		...
		$word_info = array('word' => '', 'replacement' => '');
                ...
                $template->assign_vars(array(
						"WORD" => htmlspecialchars($word_info['word'], ENT_COMPAT),
						"REPLACEMENT" => htmlspecialchars($word_info['replacement'], ENT_COMPAT),
...
else
{
        ...
        for($i = 0; $i < $word_count; $i++)
        {
                ...
                $template->assign_block_vars("words", array(
						...
						"REPLACEMENT" => htmlspecialchars($replacement, ENT_COMPAT),
