...
class emailer
{
	...
	function replyto($address)
	{
		...
		$cc = (is_array($this->addresses['cc']) && count($this->addresses['cc'])) ? implode(', ', $this->addresses['cc']) : '';
		$bcc = (is_array($this->addresses['bcc']) && count($this->addresses['bcc'])) ? implode(', ', $this->addresses['bcc']) : '';
