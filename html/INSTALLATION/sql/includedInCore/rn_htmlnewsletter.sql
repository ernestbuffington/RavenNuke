...
CREATE TABLE IF NOT EXISTS `nuke_hnl_categories` ( `cid` int(11) NOT NULL auto_increment, `ctitle` varchar(50) NOT NULL default '', `cdescription` text NOT NULL, `cblocklimit` int(4) NOT NULL default '10', PRIMARY KEY  (`cid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `nuke_hnl_cfg` ( `cfg_nm` varchar(255) NOT NULL default '', `cfg_val` longtext NOT NULL, PRIMARY KEY  (`cfg_nm`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `nuke_hnl_newsletters` ( `nid` int(11) NOT NULL auto_increment, `cid` int(11) NOT NULL default '1', `topic` varchar(100) NOT NULL default '', `sender` varchar(20) NOT NULL default '', `filename` varchar(32) NOT NULL default '', `datesent` date default NULL, `view` int(1) NOT NULL default '0', `groups` text NOT NULL, `hits` int(11) NOT NULL default '0', PRIMARY KEY  (`nid`), KEY `cid` (`cid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
