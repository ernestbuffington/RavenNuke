...
CREATE TABLE $prefix.`_banner_terms` (`terms_body` text NOT NULL, `country` varchar(255) NOT NULL default '') ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_bbcategories` ( `cat_id` mediumint(8) unsigned NOT NULL auto_increment, `cat_title` varchar(100) default NULL, `cat_order` mediumint(8) unsigned NOT NULL default '0', PRIMARY KEY  (`cat_id`), KEY `cat_order` (`cat_order`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbconfig`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbconfig` ( `config_name` varchar(255) NOT NULL default '', `config_value` varchar(255) NOT NULL default '', PRIMARY KEY  (`config_name`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_bbconfirm` ( `confirm_id` char(32) NOT NULL default '', `session_id` char(32) NOT NULL default '', `code` char(6) NOT NULL default '', PRIMARY KEY  (`session_id`,`confirm_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbdisallow`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbdisallow` ( `disallow_id` mediumint(8) unsigned NOT NULL auto_increment, `disallow_username` varchar(25) default NULL, PRIMARY KEY  (`disallow_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbforum_prune`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbforum_prune` ( `prune_id` mediumint(8) unsigned NOT NULL auto_increment, `forum_id` smallint(5) unsigned NOT NULL default '0', `prune_days` tinyint(4) unsigned NOT NULL default '0', `prune_freq` tinyint(4) unsigned NOT NULL default '0', PRIMARY KEY  (`prune_id`), KEY `forum_id` (`forum_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_bbsearch_results` ( `search_id` int(11) unsigned NOT NULL default '0', `session_id` varchar(32) NOT NULL default '', `search_array` text NOT NULL, search_time int(11) DEFAULT '0' NOT NULL, PRIMARY KEY  (`search_id`), KEY `session_id` (`session_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbsearch_wordlist`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbsearch_wordlist` ( `word_text` varchar(50) binary NOT NULL default '', `word_id` mediumint(8) unsigned NOT NULL auto_increment, `word_common` tinyint(1) unsigned NOT NULL default '0', PRIMARY KEY  (`word_text`), KEY `word_id` (`word_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbsearch_wordmatch`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbsearch_wordmatch` ( `post_id` mediumint(8) unsigned NOT NULL default '0', `word_id` mediumint(8) unsigned NOT NULL default '0', `title_match` tinyint(1) NOT NULL default '0', KEY `word_id` (`word_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_bbsessions_keys` ( `key_id` varchar(32) NOT NULL default '0', `user_id` mediumint(8) NOT NULL default '0', `last_ip` varchar(8) NOT NULL default '0', `last_login` int(11) NOT NULL default '0', PRIMARY KEY  (`key_id`,`user_id`), KEY `last_login` (`last_login`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbsmilies`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbsmilies` ( `smilies_id` smallint(5) unsigned NOT NULL auto_increment, `code` varchar(50) default NULL, `smile_url` varchar(100) default NULL, `emoticon` varchar(75) default NULL, PRIMARY KEY  (`smilies_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_bbtopics` ( `topic_id` mediumint(8) unsigned NOT NULL auto_increment, `forum_id` smallint(8) unsigned NOT NULL default '0', `topic_title` char(60) NOT NULL default '', `topic_poster` mediumint(8) NOT NULL default '0', `topic_time` int(11) NOT NULL default '0', `topic_views` mediumint(8) unsigned NOT NULL default '0', `topic_replies` mediumint(8) unsigned NOT NULL default '0', `topic_status` tinyint(3) NOT NULL default '0', `topic_vote` tinyint(1) NOT NULL default '0', `topic_type` tinyint(3) NOT NULL default '0', `topic_last_post_id` mediumint(8) unsigned NOT NULL default '0', `topic_first_post_id` mediumint(8) unsigned NOT NULL default '0', `topic_moved_id` mediumint(8) unsigned NOT NULL default '0', PRIMARY KEY  (`topic_id`), KEY `forum_id` (`forum_id`), KEY `topic_moved_id` (`topic_moved_id`), KEY `topic_status` (`topic_status`), KEY `topic_type` (`topic_type`), KEY `topic_last_post_id` (`topic_last_post_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbtopics_watch`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbtopics_watch` ( `topic_id` mediumint(8) unsigned NOT NULL default '0', `user_id` mediumint(8) NOT NULL default '0', `notify_status` tinyint(1) NOT NULL default '0', KEY `topic_id` (`topic_id`), KEY `user_id` (`user_id`), KEY `notify_status` (`notify_status`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbuser_group`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbuser_group` ( `group_id` mediumint(8) NOT NULL default '0', `user_id` mediumint(8) NOT NULL default '0', `user_pending` tinyint(1) default NULL, KEY `group_id` (`group_id`), KEY `user_id` (`user_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_bbvote_desc` ( `vote_id` mediumint(8) unsigned NOT NULL auto_increment, `topic_id` mediumint(8) unsigned NOT NULL default '0', `vote_text` text NOT NULL, `vote_start` int(11) NOT NULL default '0', `vote_length` int(11) NOT NULL default '0', PRIMARY KEY  (`vote_id`), KEY `topic_id` (`topic_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbvote_results`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbvote_results` ( `vote_id` mediumint(8) unsigned NOT NULL default '0', `vote_option_id` tinyint(4) unsigned NOT NULL default '0', `vote_option_text` varchar(255) NOT NULL default '', `vote_result` int(11) NOT NULL default '0', KEY `vote_option_id` (`vote_option_id`), KEY `vote_id` (`vote_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbvote_voters`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbvote_voters` ( `vote_id` mediumint(8) unsigned NOT NULL default '0', `vote_user_id` mediumint(8) NOT NULL default '0', `vote_user_ip` char(8) NOT NULL default '', KEY `vote_id` (`vote_id`), KEY `vote_user_id` (`vote_user_id`), KEY `vote_user_ip` (`vote_user_ip`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_bbwords`;
CREATE TABLE IF NOT EXISTS $prefix.`_bbwords` ( `word_id` mediumint(8) unsigned NOT NULL auto_increment, `word` char(100) NOT NULL default '', `replacement` char(100) NOT NULL default '', PRIMARY KEY  (`word_id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_blocks`;
CREATE TABLE IF NOT EXISTS $prefix.`_blocks` ( `bid` int(10) NOT NULL auto_increment, `bkey` varchar(15) NOT NULL default '', `title` varchar(60) NOT NULL default '', `content` text NOT NULL, `url` varchar(200) NOT NULL default '', `bposition` char(1) NOT NULL default '', `weight` int(10) NOT NULL default '1', `active` int(1) NOT NULL default '1', `refresh` int(10) NOT NULL default '0', `time` varchar(14) NOT NULL default '0', `blanguage` varchar(30) NOT NULL default '', `blockfile` varchar(255) NOT NULL default '', `view` int(1) NOT NULL default '0', `expire` varchar(14) NOT NULL default '0', `action` char(1) NOT NULL default '', `subscription` int(1) NOT NULL default '0', `max_rss_items` int(5) NOT NULL default '0' , PRIMARY KEY  (`bid`), KEY `title` (`title`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_encyclopedia` ( `eid` int(10) NOT NULL auto_increment, `title` varchar(255) NOT NULL default '', `description` text NOT NULL, `elanguage` varchar(30) NOT NULL default '', `active` int(1) NOT NULL default '0', PRIMARY KEY  (`eid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_encyclopedia_text`;
CREATE TABLE IF NOT EXISTS $prefix.`_encyclopedia_text` ( `tid` int(10) NOT NULL auto_increment, `eid` int(10) NOT NULL default '0', `title` varchar(255) NOT NULL default '', `text` text NOT NULL, `counter` int(10) NOT NULL default '0', PRIMARY KEY  (`tid`), KEY `eid` (`eid`), KEY `title` (`title`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_faqanswer`;
CREATE TABLE IF NOT EXISTS $prefix.`_faqanswer` ( `id` tinyint(4) NOT NULL auto_increment, `id_cat` tinyint(4) NOT NULL default '0', `question` varchar(255) default '', `answer` text, PRIMARY KEY  (`id`), KEY `id_cat` (`id_cat`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_faqcategories`;
CREATE TABLE IF NOT EXISTS $prefix.`_faqcategories` ( `id_cat` tinyint(3) NOT NULL auto_increment, `categories` varchar(255) default NULL, `flanguage` varchar(30) NOT NULL default '', PRIMARY KEY  (`id_cat`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_groups`;
CREATE TABLE IF NOT EXISTS $prefix.`_groups` ( `id` int(10) NOT NULL auto_increment, `name` varchar(255) NOT NULL default '', `description` text NOT NULL, `points` int(10) NOT NULL default '0', PRIMARY KEY `id` (`id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_groups_points`;
CREATE TABLE IF NOT EXISTS $prefix.`_groups_points` ( `id` int(10) NOT NULL auto_increment, `points` int(10) NOT NULL default '0', PRIMARY KEY `id` (`id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_links_categories` ( `cid` int(11) NOT NULL auto_increment, `title` varchar(50) NOT NULL default '', `cdescription` text NOT NULL, `parentid` int(11) NOT NULL default '0', PRIMARY KEY  (`cid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_links_editorials`;
CREATE TABLE IF NOT EXISTS $prefix.`_links_editorials` ( `linkid` int(11) NOT NULL default '0', `adminid` varchar(60) NOT NULL default '', `editorialtimestamp` datetime NOT NULL default '1000-01-01 00:00:00', `editorialtext` text NOT NULL, `editorialtitle` varchar(100) NOT NULL default '', PRIMARY KEY  (`linkid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_links_links`;
CREATE TABLE IF NOT EXISTS $prefix.`_links_links` ( `lid` int(11) NOT NULL auto_increment, `cid` int(11) NOT NULL default '0', `sid` int(11) NOT NULL default '0', `title` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `description` text NOT NULL, `date` datetime default NULL, `name` varchar(100) NOT NULL default '', `email` varchar(100) NOT NULL default '', `hits` int(11) NOT NULL default '0', `submitter` varchar(60) NOT NULL default '', `linkratingsummary` double(6,4) NOT NULL default '0.0000', `totalvotes` int(11) NOT NULL default '0', `totalcomments` int(11) NOT NULL default '0', PRIMARY KEY  (`lid`), KEY `cid` (`cid`), KEY `sid` (`sid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_links_modrequest`;
CREATE TABLE IF NOT EXISTS $prefix.`_links_modrequest` ( `requestid` int(11) NOT NULL auto_increment, `lid` int(11) NOT NULL default '0', `cid` int(11) NOT NULL default '0', `sid` int(11) NOT NULL default '0', `title` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `description` text NOT NULL, `modifysubmitter` varchar(60) NOT NULL default '', `brokenlink` int(3) NOT NULL default '0', PRIMARY KEY  (`requestid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_links_newlink`;
CREATE TABLE IF NOT EXISTS $prefix.`_links_newlink` ( `lid` int(11) NOT NULL auto_increment, `cid` int(11) NOT NULL default '0', `sid` int(11) NOT NULL default '0', `title` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `description` text NOT NULL, `name` varchar(100) NOT NULL default '', `email` varchar(100) NOT NULL default '', `submitter` varchar(60) NOT NULL default '', PRIMARY KEY  (`lid`), KEY `cid` (`cid`), KEY `sid` (`sid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_links_votedata`;
CREATE TABLE IF NOT EXISTS $prefix.`_links_votedata` ( `ratingdbid` int(11) NOT NULL auto_increment, `ratinglid` int(11) NOT NULL default '0', `ratinguser` varchar(60) NOT NULL default '', `rating` int(11) NOT NULL default '0', `ratinghostname` varchar(60) NOT NULL default '', `ratingcomments` text NOT NULL, `ratingtimestamp` datetime NOT NULL default '1000-01-01 00:00:00', PRIMARY KEY  (`ratingdbid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_main`;
CREATE TABLE IF NOT EXISTS $prefix.`_main` ( `main_module` varchar(255) NOT NULL default '' ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_poll_check` ( `ip` varchar(20) NOT NULL default '', `time` varchar(14) NOT NULL default '', `pollID` int(10) NOT NULL default '0',  PRIMARY KEY  (`pollID`,`ip`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_poll_data`;
CREATE TABLE IF NOT EXISTS $prefix.`_poll_data` ( `pollID` int(11) NOT NULL default '0', `optionText` char(50) NOT NULL default '', `optionCount` int(11) NOT NULL default '0', `voteID` int(11) NOT NULL default '0' ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_poll_desc` ( `pollID` int(11) NOT NULL auto_increment, `pollTitle` varchar(100) NOT NULL default '', `timeStamp` int(11) NOT NULL default '0', `voters` mediumint(9) NOT NULL default '0', `planguage` varchar(30) NOT NULL default '', `artid` int(10) NOT NULL default '0', PRIMARY KEY  (`pollID`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_pollcomments` ( `tid` int(11) NOT NULL auto_increment, `pid` int(11) NOT NULL default '0', `pollID` int(11) NOT NULL default '0', `date` datetime default NULL, `name` varchar(60) NOT NULL default '', `email` varchar(60) default NULL, `url` varchar(60) default NULL, `host_name` varchar(60) default NULL, `subject` varchar(60) NOT NULL default '', `comment` text NOT NULL, `score` tinyint(4) NOT NULL default '0', `reason` tinyint(4) NOT NULL default '0', PRIMARY KEY  (`tid`), KEY `pid` (`pid`), KEY `pollID` (`pollID`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_public_messages`;
CREATE TABLE IF NOT EXISTS $prefix.`_public_messages` ( `mid` int(10) NOT NULL auto_increment, `content` varchar(255) NOT NULL default '', `date` varchar(14) default NULL, `who` varchar(25) NOT NULL default '', PRIMARY KEY  (`mid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_queue`;
CREATE TABLE IF NOT EXISTS $prefix.`_queue` ( `qid` smallint(5) unsigned NOT NULL auto_increment, `uid` mediumint(9) NOT NULL default '0', `uname` varchar(40) NOT NULL default '', `subject` varchar(100) NOT NULL default '', `story` text, `storyext` text NOT NULL, `timestamp` datetime NOT NULL default '1000-01-01 00:00:00', `topic` varchar(20) NOT NULL default '', `alanguage` varchar(30) NOT NULL default '', PRIMARY KEY  (`qid`), KEY `uid` (`uid`), KEY `uname` (`uname`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_quotes`;

DROP TABLE IF EXISTS $prefix.`_related`;
CREATE TABLE IF NOT EXISTS $prefix.`_related` ( `rid` int(11) NOT NULL auto_increment, `tid` int(11) NOT NULL default '0', `name` varchar(30) NOT NULL default '', `url` varchar(200) NOT NULL default '', PRIMARY KEY  (`rid`), KEY `tid` (`tid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_reviews`;
CREATE TABLE IF NOT EXISTS $prefix.`_reviews` ( `id` int(10) NOT NULL auto_increment, `date` date NOT NULL default '1000-01-01', `title` varchar(150) NOT NULL default '', `text` text NOT NULL, `reviewer` varchar(25) default NULL, `email` varchar(60) default NULL, `score` int(10) NOT NULL default '0', `cover` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `url_title` varchar(50) NOT NULL default '', `hits` int(10) NOT NULL default '0', `rlanguage` varchar(30) NOT NULL default '', PRIMARY KEY  (`id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_reviews_add`;
CREATE TABLE IF NOT EXISTS $prefix.`_reviews_add` ( `id` int(10) NOT NULL auto_increment, `date` date default NULL, `title` varchar(150) NOT NULL default '', `text` text NOT NULL, `reviewer` varchar(25) NOT NULL default '', `email` varchar(60) default NULL, `score` int(10) NOT NULL default '0', `url` varchar(100) NOT NULL default '', `url_title` varchar(50) NOT NULL default '', `rlanguage` varchar(30) NOT NULL default '', PRIMARY KEY  (`id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_reviews_comments`;
CREATE TABLE IF NOT EXISTS $prefix.`_reviews_comments` ( `cid` int(10) NOT NULL auto_increment, `rid` int(10) NOT NULL default '0', `userid` varchar(25) NOT NULL default '', `date` datetime default NULL, `comments` text, `score` int(10) NOT NULL default '0', PRIMARY KEY  (`cid`), KEY `rid` (`rid`), KEY `userid` (`userid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_reviews_main`;
CREATE TABLE IF NOT EXISTS $prefix.`_reviews_main` ( `title` varchar(100) default NULL, `description` text ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $user_prefix.`_users_fields` (fid int(10) NOT NULL auto_increment, name varchar(255) NOT NULL default 'field', value varchar(255), size int(3), need int(1) NOT NULL default '1', pos int(3), public int(1) NOT NULL default '1', PRIMARY KEY  (fid) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=1;
DROP TABLE IF EXISTS $user_prefix.`_users_fields_values`;
CREATE TABLE IF NOT EXISTS $user_prefix.`_users_field_values` (vid int(10) NOT NULL auto_increment, uid int(10) NOT NULL, fid int(10) NOT NULL, value varchar(255), PRIMARY KEY  (vid), KEY `combo_fid_uid` (`fid`,`uid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=1;
DROP TABLE IF EXISTS $user_prefix.`_users_temp_field_values`;
CREATE TABLE IF NOT EXISTS $user_prefix.`_users_temp_field_values` (vid int(10) NOT NULL auto_increment, uid int(10) NOT NULL, fid int(10) NOT NULL, value varchar(255), PRIMARY KEY (vid)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=1;


DROP TABLE IF EXISTS $prefix.`_nsngr_config`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsngr_config` ( `config_name` varchar(255) NOT NULL default '', `config_value` text NOT NULL, PRIMARY KEY  (`config_name`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsngr_groups` ( `gid` int(11) NOT NULL auto_increment, `gname` varchar(32) NOT NULL default '', `gdesc` text NOT NULL, `gpublic` tinyint(1) NOT NULL default '0', `glimit` int(11) NOT NULL default '0', `phpBB` int(11) NOT NULL default '0', `muid` int(11) NOT NULL default '0', PRIMARY KEY  (`gid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsngr_users` ( `gid` int(11) NOT NULL default '0', `uid` int(11) NOT NULL default '0', `trial` tinyint(1) NOT NULL default '0', `notice` tinyint(1) NOT NULL default '0', `sdate` int(14) NOT NULL default '0', `edate` int(14) NOT NULL default '0', PRIMARY KEY  (`gid`,`uid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_hnl_categories` ( `cid` int(11) NOT NULL auto_increment, `ctitle` varchar(50) NOT NULL default '', `cdescription` text NOT NULL, `cblocklimit` int(4) NOT NULL default '10', PRIMARY KEY  (`cid`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_hnl_cfg` ( `cfg_nm` varchar(255) NOT NULL default '', `cfg_val` longtext NOT NULL, PRIMARY KEY  (`cfg_nm`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_hnl_newsletters` ( `nid` int(11) NOT NULL auto_increment, `cid` int(11) NOT NULL default '1', `topic` varchar(100) NOT NULL default '', `sender` varchar(20) NOT NULL default '', `filename` varchar(32) NOT NULL default '', `datesent` date default NULL, `view` int(1) NOT NULL default '0', `groups` text NOT NULL, `hits` int(11) NOT NULL default '0', PRIMARY KEY  (`nid`), KEY `cid` (`cid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_gcal_category` (`id` int(11) NOT NULL auto_increment,`name` varchar(128) NOT NULL default '',PRIMARY KEY  (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_gcal_rsvp` (`id` int(11) NOT NULL auto_increment,`event_id` int(11) NOT NULL,`user_id` int(11) NOT NULL,PRIMARY KEY  (`id`), KEY `event_id` (`event_id`,`user_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_gcal_exception`;
CREATE TABLE $prefix.`_gcal_exception` (`id` int(11) NOT NULL auto_increment, `event_id` int(11) NOT NULL, `date` date NOT NULL default '1000-01-01', PRIMARY KEY (`id`), KEY `event_id` (`event_id`), KEY `date` (`date`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_gcal_cat_group`;
CREATE TABLE $prefix.`_gcal_cat_group` (`id` int(11) NOT NULL auto_increment, `cat_id` int(11) NOT NULL, `group_id` int(11) NOT NULL, PRIMARY KEY (`id`), KEY `cat_id` (`cat_id`), KEY `group_id` (`group_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_legal_cfg` (`contact_email` varchar(255) NOT NULL default 'legal@MySite.com', `contact_subject` varchar(255) NOT NULL default 'Legal Notice Inquiry', `country` varchar(255) NOT NULL default 'United States of America') ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_legal_docs` (`did` int(11) NOT NULL auto_increment, `doc_name` varchar(32) NOT NULL, `doc_status` tinyint(4) NOT NULL default '0', PRIMARY KEY (`did`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_legal_text` (`tid` int(11) NOT NULL auto_increment, `doc_text` text NOT NULL, PRIMARY KEY (`tid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_legal_text_map` (`mid` mediumint(9) NOT NULL, `did` int(11) NOT NULL, `tid` int(11) NOT NULL, `language` varchar(32) NOT NULL default 'english', UNIQUE KEY `mid` (`mid`,`did`,`tid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_bbattachments_config` ( `config_name` varchar(255) NOT NULL,  `config_value` varchar(255) NOT NULL,  PRIMARY KEY (`config_name`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_bbforbidden_extensions` ( `ext_id` mediumint(8) UNSIGNED NOT NULL auto_increment,   extension varchar(100) NOT NULL,   PRIMARY KEY (`ext_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_bbextensions` ( `ext_id` mediumint(8) UNSIGNED NOT NULL auto_increment,  `group_id` mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,  `extension` varchar(100) NOT NULL,  `comment` varchar(100),  PRIMARY KEY `ext_id` (`ext_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_bbquota_limits` ( `quota_limit_id` mediumint(8) unsigned NOT NULL auto_increment,  `quota_desc` varchar(20) NOT NULL default '',  `quota_limit` bigint(20) unsigned NOT NULL default '0',  PRIMARY KEY  (`quota_limit_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_bbattach_quota` (  `user_id` mediumint(8) unsigned NOT NULL default '0',  `group_id` mediumint(8) unsigned NOT NULL default '0',  `quota_type` smallint(2) NOT NULL default '0',  `quota_limit_id` mediumint(8) unsigned NOT NULL default '0',  KEY `quota_type` (`quota_type`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_config` (`config_name` varchar(255) NOT NULL default '', `config_value` text NOT NULL) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_members` (`member_id` int(11) NOT NULL auto_increment, `member_name` varchar(255) NOT NULL default '', `member_email` varchar(255) NOT NULL default '',  PRIMARY KEY  (`member_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_members_positions`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_members_positions` (`position_id` int(11) NOT NULL auto_increment, `position_name` varchar(255) NOT NULL default '',  `position_weight` int(11) NOT NULL default '0', PRIMARY KEY  (`position_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_projects` (`project_id` int(11) NOT NULL auto_increment,  `project_name` varchar(255) NOT NULL default '',  `project_description` text NOT NULL,  `project_site` varchar(255) NOT NULL default '',  `priority_id` int(11) NOT NULL default '0',  `status_id` int(11) NOT NULL default '0',  `project_percent` float NOT NULL default '0',  `weight` int(11) NOT NULL default '0',  `featured` tinyint(2) NOT NULL default '0',  `allowreports` tinyint(2) NOT NULL default '0',  `allowrequests` tinyint(2) NOT NULL default '0',  `date_created` int(14) NOT NULL default '0',  `date_started` int(14) NOT NULL default '0',  `date_finished` int(14) NOT NULL default '0',  PRIMARY KEY  (`project_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_projects_members`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_projects_members` (  `project_id` int(11) NOT NULL default '0',  `member_id` int(11) NOT NULL default '0',  `position_id` int(11) NOT NULL default '0',  KEY `project_id` (`project_id`),  KEY `member_id` (`member_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_projects_priorities`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_projects_priorities` (  `priority_id` int(11) NOT NULL auto_increment,  `priority_name` varchar(30) NOT NULL default '',  `priority_weight` int(11) NOT NULL default '1',  PRIMARY KEY  (`priority_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_projects_status` (  `status_id` int(11) NOT NULL auto_increment,  `status_name` varchar(255) NOT NULL default '',  `status_weight` int(11) NOT NULL default '0',  PRIMARY KEY  (`status_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_reports` (  `report_id` int(11) NOT NULL auto_increment,  `project_id` int(11) NOT NULL default '0',  `type_id` int(11) NOT NULL default '0',  `status_id` int(11) NOT NULL default '0',  `report_name` varchar(255) NOT NULL default '',  `report_description` text NOT NULL,  `submitter_name` varchar(32) NOT NULL default '',  `submitter_email` varchar(255) NOT NULL default '',  `submitter_ip` varchar(20) NOT NULL default '0.0.0.0',  `date_submitted` int(14) NOT NULL default '0',  `date_commented` int(14) NOT NULL default '0',  `date_modified` int(14) NOT NULL default '0',  PRIMARY KEY  (`report_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_reports_comments`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_reports_comments` (  `comment_id` int(11) NOT NULL auto_increment,  `report_id` int(11) NOT NULL default '0',  `commenter_name` varchar(32) NOT NULL default '',  `commenter_email` varchar(255) NOT NULL default '',  `commenter_ip` varchar(20) NOT NULL default '0.0.0.0',  `comment_description` text NOT NULL,  `date_commented` int(14) NOT NULL default '0',  PRIMARY KEY  (`comment_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_reports_members`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_reports_members` (  `report_id` int(11) NOT NULL default '0',  `member_id` int(11) NOT NULL default '0',  `position_id` int(11) NOT NULL default '0',  KEY `report_id` (`report_id`),  KEY `member_id` (`member_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_reports_status`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_reports_status` (  `status_id` int(11) NOT NULL auto_increment,  `status_name` varchar(255) NOT NULL default '',  `status_weight` int(11) NOT NULL default '0',  PRIMARY KEY  (`status_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_reports_types` (  `type_id` int(11) NOT NULL auto_increment,  `type_name` varchar(255) NOT NULL default '',  `type_weight` int(11) NOT NULL default '0',  PRIMARY KEY  (`type_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_requests` (  `request_id` int(11) NOT NULL auto_increment,  `project_id` int(11) NOT NULL default '0',  `type_id` int(11) NOT NULL default '0',  `status_id` int(11) NOT NULL default '0',  `request_name` varchar(255) NOT NULL default '',  `request_description` text NOT NULL,  `submitter_name` varchar(32) NOT NULL default '',  `submitter_email` varchar(255) NOT NULL default '',  `submitter_ip` varchar(20) NOT NULL default '0.0.0.0',  `date_submitted` int(14) NOT NULL default '0',  `date_commented` int(14) NOT NULL default '0',  `date_modified` int(14) NOT NULL default '0',  PRIMARY KEY  (`request_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_requests_members` (  `request_id` int(11) NOT NULL default '0',  `member_id` int(11) NOT NULL default '0',  `position_id` int(11) NOT NULL default '0',  KEY `request_id` (`request_id`),  KEY `member_id` (`member_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_requests_status`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_requests_status` (  `status_id` int(11) NOT NULL auto_increment,  `status_name` varchar(255) NOT NULL default '',  `status_weight` int(11) NOT NULL default '0',  PRIMARY KEY  (`status_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_requests_types` (  `type_id` int(11) NOT NULL auto_increment,  `type_name` varchar(255) NOT NULL default '',  `type_weight` int(11) NOT NULL default '0',  PRIMARY KEY  (`type_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_tasks` (  `task_id` int(11) NOT NULL auto_increment,  `project_id` int(11) NOT NULL default '0',  `task_name` varchar(255) NOT NULL default '',  `task_description` text NOT NULL,  `priority_id` int(11) NOT NULL default '1',  `status_id` int(11) NOT NULL default '0',  `task_percent` float NOT NULL default '0',  `date_created` int(14) NOT NULL default '0',  `date_started` int(14) NOT NULL default '0',  `date_finished` int(14) NOT NULL default '0',  PRIMARY KEY  (`task_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_tasks_members`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_tasks_members` (  `task_id` int(11) NOT NULL default '0',  `member_id` int(11) NOT NULL default '0',  `position_id` int(11) NOT NULL default '0',  KEY `task_id` (`task_id`),  KEY `member_id` (`member_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_nsnpj_tasks_priorities`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_tasks_priorities` (  `priority_id` int(11) NOT NULL auto_increment,  `priority_name` varchar(30) NOT NULL default '',  `priority_weight` int(11) NOT NULL default '1',  PRIMARY KEY  (`priority_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnpj_tasks_status` (  `status_id` int(11) NOT NULL auto_increment,  `status_name` varchar(255) NOT NULL default '',  `status_weight` int(11) NOT NULL default '0',  PRIMARY KEY  (`status_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE $prefix.`_pages` (  `pid` int(10) NOT NULL auto_increment,  `cid` int(10) NOT NULL default '0',  `title` varchar(255) NOT NULL default '',  `subtitle` varchar(255) NOT NULL default '',  `tags` varchar(255) NOT NULL,  `active` int(1) NOT NULL default '0',  `page_header` text NOT NULL,  `text` text NOT NULL,  `page_footer` text NOT NULL,  `signature` text NOT NULL,  `date` datetime NOT NULL default '1000-01-01 00:00:00',  `counter` int(10) NOT NULL default '0',  `clanguage` varchar(30) NOT NULL default '',  `uname` varchar(40) NOT NULL default '',  PRIMARY KEY  (`pid`),  KEY `cid` (`cid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_pages_categories`;
CREATE TABLE $prefix.`_pages_categories` (  `cid` int(10) NOT NULL auto_increment,  `cimg` varchar(255) NOT NULL,  `title` varchar(255) NOT NULL default '',  `description` text NOT NULL,  PRIMARY KEY  (`cid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_pages_feat`;
CREATE TABLE $prefix.`_pages_feat` (  `cid` int(10) NOT NULL default '0',  `pid` int(10) NOT NULL default '0') ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_newpages`;
CREATE TABLE $prefix.`_newpages` (  `pid` int(10) NOT NULL auto_increment,  `cid` int(10) NOT NULL default '0',  `title` varchar(255) NOT NULL default '',  `subtitle` varchar(255) NOT NULL default '',  `tags` varchar(255) NOT NULL default '',  `page_header` text NOT NULL,  `text` text NOT NULL,  `page_footer` text NOT NULL,  `signature` text NOT NULL,  `uname` varchar(40) NOT NULL default '',  `date` datetime NOT NULL default '1000-01-01 00:00:00',  `clanguage` varchar(30) NOT NULL default '',  PRIMARY KEY  (`pid`),  KEY `cid` (`cid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_seo_dh`;
CREATE TABLE IF NOT EXISTS $prefix.`_seo_dh` (`dhid` int(11) NOT NULL auto_increment, `levelsort` int(1) NOT NULL, `title` varchar(255) NOT NULL, `id` int(11) NOT NULL, `mid` int(11) NOT NULL, `lang` varchar(30) NOT NULL, `active` int(1) NOT NULL, `metavalue` text NOT NULL, PRIMARY KEY  (`dhid`), KEY `levelsort` (`levelsort`,`title`,`id`,`mid`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO $prefix.`_seo_dh` VALUES (14, 0, '', 0, 25, '', 1, 'RavenNuke&trade; Copyright (c) 2002-2018 by Gaylen Fraley. This is free software, and you may redistribute it under the GPL (http://www.gnu.org/licenses/gpl-2.0.txt). RavenNuke&trade; is supported at https://www.ravenphpscripts.com .');

DROP TABLE IF EXISTS $prefix.`_seo_dh_master`;
CREATE TABLE IF NOT EXISTS $prefix.`_seo_dh_master` (`mid` int(11) NOT NULL auto_increment, `order` int(5) NOT NULL, `type` varchar(50) NOT NULL, `name` varchar(50) NOT NULL, `default` varchar(255) NOT NULL, `active` int(1) NOT NULL, PRIMARY KEY  (`mid`), KEY `order` (`order`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO $prefix.`_seo_dh_master` VALUES (25, 2400, 'name', 'GENERATOR', 'RavenNuke&trade; Copyright (c) 2002-2018 by Gaylen Fraley. This is free software, and you may redistribute it under the GPL (http://www.gnu.org/licenses/gpl-2.0.txt). RavenNuke&trade; is supported at https://www.ravenphpscripts.com .', 1);

CREATE TABLE IF NOT EXISTS $prefix.`_themes` ( `theme` varchar(25) NOT NULL default "", `themename` varchar(25) NOT NULL default "", `active` tinyint(1) NOT NULL default "0", `default` tinyint(1) NOT NULL default "0", `guest` tinyint(1) NOT NULL default "0", `moveableblocks` tinyint(1) NOT NULL default "0", `collapsibleblocks` tinyint(1) NOT NULL default "0", `compatible` tinyint(1) NOT NULL default "0", PRIMARY KEY (`theme`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_tags`;
CREATE TABLE IF NOT EXISTS $prefix.`_tags` ( `tag` varchar(25) NOT NULL, `cid` int(10) NOT NULL default '0', `whr` int(1) NOT NULL default '0') ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_tags_temp`;
CREATE TABLE IF NOT EXISTS $prefix.`_tags_temp` ( `tag` varchar(25) NOT NULL, `cid` int(10) NOT NULL default '0', `whr` int(1) NOT NULL default '0') ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

DROP TABLE IF EXISTS $prefix.`_ton`;
CREATE TABLE IF NOT EXISTS $prefix.`_ton` (  `newsrows` int(1) NOT NULL default '0',`bookmark` int(1) NOT NULL default '0', `rblocks` int(1) NOT NULL default '0', `linklocation` varchar(6) NOT NULL default '0', `articlelink` int(1) NOT NULL default '0', `artview` varchar(3) NOT NULL default '0', `TON_useTitleLink` int(1) NOT NULL default '0', `TON_usePDF` int(1) NOT NULL default '0', `TON_useRating` int(1) NOT NULL default '0', `TON_useSendToFriend` int(1) NOT NULL default '0', `showtags` int(1) NOT NULL default '0', `TON_useCharLimit` int(1) NOT NULL default '0', `TON_CharLimit` int(3) NOT NULL default '0', `topadact` int(1) NOT NULL default '0', `topad` int(3) NOT NULL default '0', `bottomadact` int(1) NOT NULL default '0', `bottomad` int(3) NOT NULL default '0', `usedisqus` int(1) NOT NULL default '0', `shortname` varchar(25) NOT NULL default '0', `googlapi` varchar(44) NULL, `usegooglsb` int(1) NOT NULL default '0', `usegooglart` int(1) NOT NULL default '0') ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
