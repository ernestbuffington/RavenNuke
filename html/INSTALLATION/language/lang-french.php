...
define('_rnINSTALLER_INTENT','      For detailed help consult the forums at https://www.ravenphpscripts.com and the included documentation.  These steps must be completed in the order shown. The first 2 steps are required. Step 3 is optional, but highly recommended as it will facilitate your IP Tracking through NukeSentinel&trade;.');
...
define('_rnLOAD_SERVER_ENVIRONMENT_CHECK','Ravenstaller Server Environment Check');
define('_rnRUN','Run');
?>